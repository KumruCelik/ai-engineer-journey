...
kaydı. Her hafta bir klasör: notlar, araştırma yazıları, kontrol soruları ve
retro.
...
| 2–4 | Python & yazılım mühendisliği disiplini | [py-core].(https://github.com/KumruCelik/py-core) , mini-etl | ⬜ |
